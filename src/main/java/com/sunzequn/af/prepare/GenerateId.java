...
//        handleFiles(CONF.GEONAMES_CORE_TRIPLES, CONF.GEONAMES_ID_URI, CONF.GEONAMES_ID_PROP, CONF.GEONAMES_ID_LITERAL);
        handleFiles(CONF.DBPEDIA_CORE_TRIPLES, CONF.DBPEDIA_ID_URI, CONF.DBPEDIA_ID_PROP, CONF.DBPEDIA_ID_LITERAL);
    }

    private static void handleFiles(String file, String fid, String fprop, String fliteral) throws Exception {
        ...
        TimeUtil.start();
        //处理uri的id
        toFile(uris, fid, "U", CONF.SPLIT, BATCH_SIZE);

        //处理prop的id
        toFile(props, fprop, "P", CONF.SPLIT, BATCH_SIZE);

        //处理literal的id
        toFile(literals, fliteral, "L", CONF.SPLIT, BATCH_SIZE);
